...
public class Conditions
{
	...
	[JsonPropertyName("itemValid")]
	public bool ItemValid { get; set; }

	[JsonPropertyName("selfSwitchCh")]
	public char SelfSwitchCh { get; set; }

	[JsonPropertyName("selfSwitchValid")]
	public bool SelfSwitchValid { get; set; }

	[JsonPropertyName("switch1Id")]
	public int Switch1Id { get; set; }

	[JsonPropertyName("switch1Valid")]
	public bool Switch1Valid { get; set; }

	[JsonPropertyName("switch2Id")]
	public int Switch2Id { get; set; }

	[JsonPropertyName("switch2Valid")]
	public bool Switch2Valid { get; set; }

	[JsonPropertyName("variableId")]
	public int VariableId { get; set; }

	[JsonPropertyName("variableValid")]
